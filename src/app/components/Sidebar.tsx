      ...
      items: [
        {
          ...
          children: [
            ...
            { id: 'assets', label: t.nav.assets, icon: FileText },
            { id: 'asset-transactions', label: t.nav.assetTransactions, icon: FileText },
            { id: 'asset-sources', label: t.nav.assetSources, icon: FileText },
            { id: 'asset-components', label: t.nav.assetComponents, icon: FileText },
