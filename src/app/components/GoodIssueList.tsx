...
interface GoodIssueListProps {
    onCreateClick: () => void;
}

export default function GoodIssueList({ onCreateClick }: GoodIssueListProps) {
    const [searchText, setSearchText] = useState('');
    const [selectedRows, setSelectedRows] = useState<number[]>([]);
    const [statusFilter, setStatusFilter] = useState('all');
    const { t } = useLanguage();

    const [data] = useState<GoodIssueRow[]>([
        {
            id: 1,
            docNumber: 'PX-2025-0147',
            docDate: '2025-01-06',
            warehouse: 'Kho Chính',
            objectCode: 'KH-001',
        ...
        {
            id: 2,
            docNumber: 'PX-2025-0148',
            docDate: '2025-01-07',
            warehouse: 'Kho Sản Xuất',
            objectCode: 'KH-002',
            objectName: 'Xưởng Cơ Khí XYZ',
            type: 'Xuất kho',
        ...
        {
            id: 3,
            docNumber: 'PX-2025-0149',
            docDate: '2025-01-08',
            warehouse: 'Kho Chính',
            objectCode: 'KH-003',
            objectName: 'Đại lý Minh Phát',
            type: 'Chuyển kho',
            totalAmount: 8400000,
            status: 'Pending',
        }
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="bg-white border-b px-6 py-4">
                    <h1 className="text-xl font-semibold text-gray-800 uppercase tracking-tight">Phiếu Xuất Kho</h1>
                    <p className="text-sm text-gray-500 mt-1">Quản lý phiếu xuất kho và vật tư</p>
                </div>
                    ...
                    <table className="w-full text-sm min-w-[1000px]">
                        <thead className="sticky top-0 z-10">
                            <tr className="bg-gray-50 border-b">
                                ...
                                <th className="px-3 py-3 text-left text-gray-700 font-semibold border-r w-32">Ngày lập</th>
