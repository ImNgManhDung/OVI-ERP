          ...
          <table className="w-full text-sm min-w-[3500px]">
            <thead className="sticky top-0 z-10">
              <tr className="bg-[#f0f7ff] border-b">
                ...
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-32 bg-[#f0f7ff] sticky left-12 z-20">
                  Legal Entity ID
                </th>
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-32">
                  Legal Entity Code
                </th>
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-64">
                  Legal Entity Name
                </th>
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-64">
                  Description
                ...
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-48">
                ...
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-96">
                  Address
                </th>
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-48">
                ...
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-40">
                  Type
                </th>
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase border-r w-32">
                  Currency
                ...
                <th className="px-3 py-3 text-left text-blue-700 font-bold uppercase w-32">
                  Create Date
                </th>
              </tr>
            </thead>
            <tbody>
              {filteredRows.length === 0 ? (
                <tr>
                  <td
                    colSpan={20}
                    className="px-3 py-12 text-center text-gray-500 bg-white"
                  >
                ...
                filteredRows.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 border-r text-right font-semibold text-green-700">
                    ...
                    <td className="px-3 py-2 border-r text-xs text-blue-600">
