...
export default function AccountDeterminationRuleList() {
  ...
  return (
    <div className="p-6">
      <div className="mb-4">
        <h1 className="text-2xl font-semibold text-gray-800 uppercase tracking-tight">Account Determination Rule</h1>
        <p className="text-sm text-gray-500 mt-1">
          Configure accounting rules with hierarchical structure
        </p>
      </div>
      ...
      <div className="bg-white border border-t-0 rounded-b-lg overflow-hidden shadow-sm">
        ...
        <div className="px-4 py-3 border-t bg-gray-50 text-xs text-right text-gray-500 font-medium">
          TOTAL VISIBLE RECORDS: {filteredData.length}
        </div>
      </div>
    </div>
  );
