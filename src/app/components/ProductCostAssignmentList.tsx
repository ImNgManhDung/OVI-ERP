...
export default function ProductCostAssignmentList() {
  ...
  const filteredData = data.filter(row => {
    ...
    const matchesType = selectedType === 'all' || row.pcaType === selectedType;
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white border-b px-6 py-4">
          <h1 className="text-xl font-semibold text-gray-800">Product Cost Assignment Management</h1>
          <nav className="flex items-center gap-1.5 mt-1">
            <span className="text-xs text-gray-400">Home</span>
            <span className="text-xs text-gray-300">/</span>
            <span className="text-xs text-gray-400">Master Data</span>
            <span className="text-xs text-gray-300">/</span>
            <span className="text-xs text-blue-600">Product Cost Assignment</span>
          </nav>
        </div>
