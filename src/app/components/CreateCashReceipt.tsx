...
interface CreateCashReceiptProps {
  onClose: () => void;
}
...
export default function CreateCashReceipt({ onClose }: CreateCashReceiptProps) {
  const [mainTab, setMainTab] = useState('main-info');
  const [detailsTab, setDetailsTab] = useState('cash-receipt-details');
    ...
    <div className="min-h-screen bg-gray-50 p-6 overflow-x-auto">
      <div className="bg-white rounded-lg shadow-sm" style={{ width: '1600px' }}>
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg">CREATE CASH RECEIPT</h2>
        ...
        <Tabs value={mainTab} onValueChange={setMainTab} className="w-full">
          ...
          <TabsContent value="main-info" className="p-0">
                ...
                <div className="border rounded-lg p-4 bg-white">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="col-span-3">
                      ...
                      <Input className="h-10" placeholder="Mô tả phiếu thu" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="border rounded-lg p-4 bg-white">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="col-span-2">
                      ...
                      <Input className="bg-pink-50 h-10" defaultValue="CÔNG TY TNHH ABC" />
                    </div>
                    ...
                    <div>
                      ...
                      <Input className="h-10 bg-gray-100" defaultValue="111" disabled />
                    </div>
                    ...
                    <div>
                      ...
                      <Input className="bg-pink-50 h-10" type="number" defaultValue="15000000" />
                    </div>
                ...
                <div className="border rounded-lg p-4 bg-white">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="col-span-2">
                      ...
                      <Input className="h-10" defaultValue="CÔNG TY ABC" />
                    </div>

                    <div className="col-span-2">
                      <Label className="text-sm mb-1 block">ADDRESS</Label>
                      <Input className="h-10" defaultValue="123 Nguyễn Văn A, Q1, TP.HCM" />
                    </div>
            ...
            <div className="mt-6">
              <Tabs value={detailsTab} onValueChange={setDetailsTab} className="w-full">
                ...
                {/* Cash Receipt Details Tab */}
                <TabsContent value="cash-receipt-details" className="mt-4">
          ...
          <TabsContent value="financial-info" className="p-6">
            <div className="flex gap-6 mb-6" style={{ width: '1552px' }}>
              ...
              <div style={{ width: '440px' }}>
                <div className="border rounded-lg p-4 bg-white">
                  <h3 className="text-sm font-semibold mb-4 text-gray-700">FINANCIAL INFO & EXCHANGE RATE</h3>
                  <div className="grid grid-cols-3 gap-4">
              ...
              <div style={{ width: '440px' }}>
                <div className="border rounded-lg p-4 bg-white">
                  <h3 className="text-sm font-semibold mb-4 text-gray-700">REFERENCES</h3>
